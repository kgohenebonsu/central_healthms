                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <?php echo $row['fname'] . " " . $row['lname'] . "'s"?> <small>Visit</small>
                        </h1>
                    </div>
                </div>
                <div class="row">
                    ...
                    if (isset($_REQUEST['id'])) {
                        $id = $_REQUEST['id'];
                        see_patient_visits_by_id($id);
                    }
                            
                        ?>
                    </div>
                    <div class="col-lg-4">
                            <h4 align="right">New Visit Details</h4>
                        <form action='health_action.php?add_patient_visit' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              <input type='hidden' class='form-control' value="<?php echo $_SESSION['h_id'] ?>"  name='h_id' id='h_id' placeholder='' aria-describedby='basic-addon1'>
                            </div><br>
                            <?php
                            display_con_room();
                            echo "<br>";
                            echo "<div class='input-group'>
                              ...
                              <input type='number' class='form-control' name='temperature' id='temperature' placeholder='' aria-describedby='basic-addon1'>
                            ";
                            display_temp();
                            echo "</div>";
                            echo "<br>";
                            echo "<div class='input-group'>
                              ...
                              <input type='text' class='form-control' name='blood_pressure' id='blood_pressure' placeholder='' aria-describedby='basic-addon1'>
                            </div>";

                            echo "<br>";
                            echo "<div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Weight</span>
                              <input type='number' class='form-control' name='weight_value' id='weight_value' placeholder='' aria-describedby='basic-addon1'>
                            ";
                            display_weight();
                            echo "</div>";
                            ...
                            echo "<div class='input-group'>
                              ...
                              <input type='number' class='form-control' name='height_value' id='height_value' placeholder='' aria-describedby='basic-addon1'>
                            ";
                            display_height();
                            echo "</div>";
                            ...
                            <div class='input-group'>
                              ...
                              <textarea type='text' 
                              class='form-control' value="" name='symptoms' id='symptoms' aria-describedby='basic-addon1'></textarea>
                            </div><br>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Lab Tests</span>
                              <textarea type='text' 
                              class='form-control' value="" name='lab_tests' id='lab_tests' aria-describedby='basic-addon1'></textarea>
                            </div><br>
                            <div class='input-group'>
                            ...
                            <div class='input-group'>
                              ...
                              <textarea type='text' 
                              class='form-control' value="" name='prescription' id='prescription' aria-describedby='basic-addon1'></textarea>
                            </div><br>
                            <?php
                                display_payments();
                                echo "<br>";
                            ...
                            <div class='input-group'>
                              ...
                              <input type='text' class='form-control' name='amount_paid' id='amount_paid' placeholder='' aria-describedby='basic-addon1'>
                            </div><br>
                            <input type='hidden' class='form-control' name='id' id='id' 
                              value="<?php echo $id; ?>" aria-describedby='basic-addon1'>
                            <button type='submit' name='submit' class='btn btn-success'>Add Visit Details</button>
                        </form>
                    </div>
                </div>
