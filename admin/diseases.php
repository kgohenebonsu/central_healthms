        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            System Settings <small>Diseases</small>
                        </h1>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h4 align="right">Add New Disease</h4>
                        <form action='health_action.php?add_disease' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Disease</span>
                              <input type='text' class='form-control' name='disease' id='disease' placeholder='' aria-describedby='basic-addon1'>
                            </div><br>
