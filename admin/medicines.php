        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            System Settings <small>Medicines</small>
                        </h1>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h4 align="right">Add New Medicine</h4>
                        <form action='health_action.php?add_medicine' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Medicine</span>
                              <input type='text' class='form-control' name='medicine' id='medicine' placeholder='' aria-describedby='basic-addon1'>
                            </div><br>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Description</span>
                              <textarea style="min-height:100px;max-height:100px; max-width:400px" type='text' 
                              class='form-control' name='description' id='description' aria-describedby='basic-addon1'></textarea>
                            </div><br>
