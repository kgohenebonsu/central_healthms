    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <h4><a href="consulting_rooms.php">Return To List</a></h4>
                    </div>
                    <div class="col-lg-4">
                        <br><br>
                        <form action='health_action.php?edit_room' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              ...
                              value="<?php echo $row['room_name'] ?>" placeholder='' aria-describedby='basic-addon1'>

                              <input type='hidden' class='form-control' name='room_id' id='room_id' 
                              value="<?php echo $row['room_id'] ?>" aria-describedby='basic-addon1'>
