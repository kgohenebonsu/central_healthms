    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h4><a href="diseases.php">Diseases</a></h4>
                    </div>
                    <div class="col-lg-6">
                        <h4><a href="consulting_rooms.php">Consulting Rooms</a></h4>
                    </div>
                </div><br><br><br>

                <div class="row">
                    <div class="col-lg-6">
                        <h4><a href="medicines.php">Medicines</a></h4>
                    </div>
                    <div class="col-lg-6">
                        <h4><a href="payment_modes.php">Payment Modes</a></h4>
                    </div>
                </div><br><br><br>

                <div class="row">
                    <div class="col-lg-6">
                        <h4><a href="wards.php">Wards</a></h4>
                    </div>
                    <div class="col-lg-6">
