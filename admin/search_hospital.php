                    ...
                    <div class="col-lg-8">
                        <?php
                          ...
                          if(! $obj->connect()){
                            ...
                            $result=$obj->search_hospital($search);

                            
                            //$row=$obj->fetch();

                            if ($result == null) {
                                echo "<br><center><h4>No Registered Hospitals were found with name... 
                            ...
                            while($result){
                                ...
                                echo "<td>$result[h_location]</td>";
                                echo "<td>$result[h_contact]</td>";
                                echo "<td><a href='hospital_details.php?id=$result[h_id]'>View Details</a></td>";
                                echo "</tr>";
