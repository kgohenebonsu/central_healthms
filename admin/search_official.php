                    ...
                    <div class="col-lg-8">
                        <?php
                          ...
                          if(! $obj->connect()){
                            ...
                            $result=$obj->search_health_official($search);

                            
                            //$row=$obj->fetch();

                            if ($result == null) {
                                echo "<br><center><h4>No Registered Officials were found with name... 
                            ...
                            while($result){
                                echo "<tr>";
                                echo "<td>$result[o_system_id]</td>";
                                echo "<td>$result[o_fname] $result[o_lname]</td>";
                                echo "<td>$result[h_name]</td>";
                                echo "<td>$result[o_contact]</td>";
                                echo "<td><a href='health_official_details.php?id=$result[o_id]'>View Details</a></td>";
                                echo "</tr>";
