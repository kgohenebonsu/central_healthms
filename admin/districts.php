        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <br><br>
                        <form action='health_action.php?add_district' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>District Name</span>
                              <input type='text' class='form-control' name='district_name' id='district_name' placeholder='district' aria-describedby='basic-addon1'>
                            </div>
                            <center><h3>IN</h3></center>
                            <?php
                            display_regions();?><br>
                            <button type='submit' name='submit' class='btn btn-success'>Add District</button>
                        </form>
                    </div>
                    <!-- <div class="col-lg-4">
                    </div> -->
