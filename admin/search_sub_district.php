                    ...
                    <div class="col-lg-9">
                        ...
                        include("health_functions.php");
                          ...
                          if(! $obj->connect()){
                            ...
                            $result=$obj->search_sub_district($search);
                            ...
                            while($result){
                                echo "<tr>";
                                echo "<td>$result[sub_district_name]</td>";
                                echo "<td>$result[district_name]</td>";
                                echo "<td><a href='update_sub_district.php?id=$result[sub_district_id]'>Click To Update</a></td>";
                                echo "</tr>";
