        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            System Settings <small>Payment Modes</small>
                        </h1>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h4 align="right">Add New Payment Mode</h4>
                        <form action='health_action.php?add_payment_mode' method='POST' class='form-horizontal'>
                            <div class='input-group'>
                              <span class='input-group-addon' id='basic-addon1'>Payment Mode</span>
                              <input type='text' class='form-control' name='pm_name' id='pm_name' placeholder='' aria-describedby='basic-addon1'>
                            </div><br>
